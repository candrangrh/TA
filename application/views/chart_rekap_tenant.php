...
<body>
    ...
    <section style="margin:30px 40px;">
        ...
        <div class="dropdown" style="margin:0 30px 0px 35px;">
            ...
            <div class="dropdown-menu">
                <?php foreach ($tenant as $t) : ?>
                    <a class="dropdown-item" href="<?php echo site_url('K_tenant/chart_detail_rekap/' . $t['nama_tenant']); ?>">
        ...
        foreach ($rekap as $result) {
            ...
            $value[] = (float)$result['bersih_tenant']; //ambil nilai
        }
        /* end mengambil query*/
